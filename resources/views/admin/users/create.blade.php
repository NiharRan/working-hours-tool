            ...
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <select id="role" name="role" value="{{ old('role') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div>
                        <x-jet-label class="font-bold" for="email" value="{{ __('Password') }}" />
