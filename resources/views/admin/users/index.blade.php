                ...
                <div class="bg-white shadow-xl sm:rounded-lg">
                    ...
                    <table class="border border-collapse w-full">
                        ...
                        <tr>
                            ...
                            <th class="border text-left px-2 py-1">{{ __('Username') }}</th>
                            <th class="border text-left px-2 py-1">{{ __('E-mail') }}</th>
                            <th class="border text-left px-2 py-1">{{ __('Role') }}</th>
                        ...
                        @if($users->count() > 0)
                            @foreach($users as $item)
                                <tr>
                                    ...
                                    <th class="border text-left px-2 py-1">{{ $item->username }}</th>
                                    <th class="border text-left px-2 py-1">{{ $item->email }}</th>
                                    <th class="border text-left px-2 py-1">{{ $item->role }}</th>
